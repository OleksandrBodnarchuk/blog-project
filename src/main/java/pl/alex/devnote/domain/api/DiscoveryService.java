...
public class DiscoveryService {
    ...
    public List<DiscoveryBasicDTO> findAllDiscoveriesByCategoryId(int id){
        return discoveryDAO.findByCategoryId(id).stream().map(DiscoveryMapper::map).collect(Collectors.toList());
    }
